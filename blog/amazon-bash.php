...
?>
    ...
    <h3>Lock</h3>
    <p>
        First of all I had to slightly dismantle the Slide Bolt due to it being quite difficult to open and close as I am sure you have come across before. - The point of this high friction, I believe, is so that someone can't rattle open the lock, which is not possible in our case because the lock will be held in place by our motor... more on that later.<br>
    ...
    <p>
        ...
        It is now the hard part. You need to create a sort of hing from the flat edges of the
